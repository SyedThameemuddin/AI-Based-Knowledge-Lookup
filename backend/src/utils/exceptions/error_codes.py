...
ErrorCodeStatus = {
    # Configuration Errors
    ErrorCode.MISSING_ENV_VARS: "PROJECT_ENV_001",
    
    # Business & Application Errors
    ErrorCode.USER_NOT_FOUND: "PROJECT_SQL_002",
    ErrorCode.WORK_ITEM_NOT_FOUND: "PROJECT_SQL_008",
    ErrorCode.ESCALATE_TO_LANE: "PROJECT_ESC_001",
    ErrorCode.NO_ROWS_AFFECTED: "PROJECT_SQL_009",
    ErrorCode.CONFLICT: "PROJECT_SQL_011",
    
    # Input & Validation Errors
    ErrorCode.INVALID_JSON_FORMAT: "PROJECT_ENV_003",
    ErrorCode.VALIDATION_ERROR: "PROJECT_VAL_004",
    
    # Header Validation Errors
    ErrorCode.MISSING_HEADERS: "PROJECT_HDR_001",
    ErrorCode.MISSING_AUTHORIZATION_HEADER: "PROJECT_HDR_002",
    ErrorCode.INVALID_AUTHORIZATION_HEADER: "PROJECT_HDR_003",
    ErrorCode.EMPTY_AUTHORIZATION_HEADER: "PROJECT_HDR_004",
    ErrorCode.MISSING_REQUESTER_ID_HEADER: "PROJECT_HDR_005",
    ErrorCode.INVALID_REQUESTER_ID_HEADER: "PROJECT_HDR_006",
    ErrorCode.EMPTY_REQUESTER_ID_HEADER: "PROJECT_HDR_007",
    
    # System & Internal Errors
    ErrorCode.INTERNAL_SERVER_ERROR: "PROJECT_SQL_005",
    ErrorCode.DATABASE_ERROR: "PROJECT_SQL_006",
    ErrorCode.SERIALIZE_EVENT_DATA: "PROJECT_SER_001",
    ErrorCode.COMMIT_TRANSACTION: "PROJECT_SQL_010",
    ErrorCode.EXTERNAL_API_FAILED: "PROJECT_EX_001",
    
    # Authentication & Authorization Errors
    ErrorCode.UNAUTHORIZED: "PROJECT_AUTH_007",
    # ===== OM-Specific Aliases (used in your sequence diagrams) =====
    # Validation
    "OM_VAL_004": "OM_VAL_004",
    # DB connection
    "OM_SQL_002": "OM_SQL_002",
    # Insert / staging
    "OM_SQL_005": "OM_SQL_005",
    # Commit / transaction
    "OM_SQL_006": "OM_SQL_006"
}