...
### Page 4: History (/app/history)
A dedicated chronological feed for system interactions.
- Provides a clean, scrolling feed of all queries and answers generated by the RAG backend.
- Displays fully formatted Markdown text, rendering identical to the live chat interface.
- Includes timestamp metadata and source retrieval counts.
